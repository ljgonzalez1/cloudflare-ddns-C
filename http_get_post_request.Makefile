# -------------------------------------------------------------------
# Makefile para compilar LibreSSL y generar /bin/http_get_post_request.bin
# -------------------------------------------------------------------
...
CC := gcc
# Añadimos -I$(LIBRESSL_SRC)/include antes que cualquier otra ruta para tomar los headers de LibreSSL
...
# Paso 1: Limpiar e instalar LibreSSL en modo estático
libressl:
